...
(function() {
    ...
    const COLORS = { primary: '#ffd22e', dark: '#121212', white: '#ffffff', gray: '#1c1c1c', border: '#222', red: '#ff4444' };
    const KNOWN_SERVERS = ['206.81.27', '102.105.120', '81.49.17', '154.127.57', '142.250', '172.217', '216.58', '74.125'];
    const btnStyle = `padding:8px;border:none;background:${COLORS.primary};color:${COLORS.dark};border-radius:6px;cursor:pointer;font-weight:600;transition:all 0.2s;`;
    const itemStyle = `display:flex;flex-direction:column;background-color:${COLORS.gray};border-left:4px solid ${COLORS.primary};padding:15px;margin-bottom:12px;border-radius:8px;color:${COLORS.white};`;
